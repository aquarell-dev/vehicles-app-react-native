...
const Car: FC<TCar> = ({ id, driver, title, carType, photo, city }) => {
	return (
		<View className='bg-background-secondary my-2 flex flex-row space-x-2 rounded-xl'>
			...
			<View className='px-4 py-2 flex justify-between space-y-1'>
				...
				<View className='flex flex-row space-x-1 items-center'>
					...
					<Text className='text-md text-text-primary font-medium'>{city}</Text>
				</View>
				<View className='w-28'>
					<PrimaryButton>
